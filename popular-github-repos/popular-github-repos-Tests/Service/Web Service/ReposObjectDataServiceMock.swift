//
//  ReposObjectDataServiceMock.swift
...
class ReposObjectDataServiceMock: DataServiceProtocol {
    func fetchData(for url: URL, completion: @escaping fetchDataCompletion) {
        let bundle = Bundle(for: type(of: self))
        let url = bundle.url(forResource: "ReposObjectResponseMock", withExtension: "json")!
